...
public class Renli2 {
    ...
    public static void readNum() throws Exception {
        FileInputStream in = new FileInputStream(new File("E:\\阜康农商银行\\2024风险保障金\\全员风险保障金台账初始化表.xls"));
        //通过输入流读取指定的Excel文件
    ...
    public static void readInitData(HashMap<String, String> numList) throws Exception {
        FileInputStream in = new FileInputStream(new File("E:\\阜康农商银行\\2024风险保障金\\2024.3.12.xls"));
        //通过输入流读取指定的Excel文件
        HSSFWorkbook excel = new HSSFWorkbook(in);
        //获取Excel文件的第1个Sheet页
